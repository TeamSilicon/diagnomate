  ...
  useEffect(() => {
    if (userProfile) {
      const welcomeMessage: Message = {
        id: '1',
        text: `Welcome to DiagnoSidekick! I see you're ${userProfile.age} years old. I'll keep your medical history in mind during our conversation. How can I help you today?`,
        isUser: false
      };
      ...
      >
        ...
        >
          <View style={styles.headerContent}>
            ...
            <Text style={styles.headerText}>DiagnoSidekick</Text>
          </View>
        </LinearGradient>
